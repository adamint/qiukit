...
public class RandomBit {
  public static void main(String[] args) {
    ...
    System.out.println("Resulted in: " + result.getState());

    System.out.println("Circuit evaluation progression:");
    System.out.print(resultProgression.stream().map(ComputationalResult::toString).collect(Collectors.joining("\n")));
